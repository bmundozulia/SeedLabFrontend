...
export class PersonalizacionesService {
  ...
  restorePersonalization(access_token: any, idPersonalizacion: any): Observable<any> {
    const options = { headers: this.CreacionHeaders(access_token) };
    return this.http.post(this.url + "restorePersonalizacion/" + idPersonalizacion, {}, options);
  }
}
